...
#     administrador_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True, related_name="prod_registrados")
#     nombre = models.CharField(max_length=50)
#     precio = models.FloatField()
#     stock = models.IntegerField()
#     fecha_registro = models.DateTimeField(auto_now_add=True)
...
#     cliente_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="comentarios")
#     comentario = models.CharField(max_length=300)
#     fecha_registro = models.DateTimeField(auto_now_add=True)
...
#     cliente_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="calificaciones")
#     cant_estrella = models.IntegerField()
#     fecha_registro = models.DateTimeField(auto_now_add=True)
...
#     cliente_id = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="solicitudes")
#     producto_id = models.ForeignKey(Producto, on_delete=models.CASCADE)
#     descripcion = models.CharField(max_length=300)
#     estado = models.BooleanField()
#     tipo_solicitud = models.CharField(max_length=20)

...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            type=int,
            default=10,
            help="Cantidad de categorías a crear.",
        )
        parser.add_argument(
            "--productos",
            type=int,
    ...
    def handle(self, *args, **options):
        ...
        cant_categorias = options["categorias"]
        ...
        # 3) Crear categorías
        self.stdout.write(self.style.NOTICE("Creando categorías..."))
        categorias = []
        for i in range(cant_categorias):
            nombre = f"Categoria {fake.word()} {i}"
        ...
        for producto in productos:
            # de 1 a 3 categorías por producto
